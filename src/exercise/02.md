...
1. useCallback is use to memoize it has array list of dependencies just like
   useEffect.

2. useCallback return a memoize function.

3. useCallback is use to prevent unnecessary renders.
